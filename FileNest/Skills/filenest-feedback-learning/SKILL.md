...
- Prefer evolving the most relevant existing system skill when the feedback refines an established search or answer workflow.
- Create a new skill only when the feedback describes a distinct reusable capability with a clear trigger.
